...
Because this package uses the colorio Python package, you need to install it in a place that reticulate can find it. 
The way I recommend is to use a Conda installation. 
...
Then, you need to create (or use) a Conda environment; I recommend you use an environment called `r-reticulate`:
